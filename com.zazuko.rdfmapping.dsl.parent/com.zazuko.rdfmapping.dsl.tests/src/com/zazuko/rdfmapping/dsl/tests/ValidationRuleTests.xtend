...
class ValidationRuleTests {
	...
	def void NoTypeDefined() {
		...
		validationTester.assertError(result,RdfMappingPackage.Literals.LOGICAL_SOURCE, null, 60, 9, "No type declared for the logical-source or source-group")
		}
		...
		def void TypeNotDefinedOnNonEnclosedLogicalSource() {
			...
			validationTester.assertError(result,RdfMappingPackage.Literals.LOGICAL_SOURCE, null, 154, 9, "No type declared for the logical-source")
		}
		...
		def void TypeShadowed() {
			...
			validationTester.assertIssue(result,RdfMappingPackage.Literals.LOGICAL_SOURCE, null, 244, 3, Severity.WARNING,"Type declared on source-group level is shadowed by type declared on logical-source.")
		}
	...
	def void NoSourceDefined() {
		...
		validationTester.assertError(result,RdfMappingPackage.Literals.LOGICAL_SOURCE, null, 199, 9, "No source declared for the logical-source or source-group")
		}
		...
		def void SourceNotDefinedOnNonEnclosedLogicalSource() {
			...
			validationTester.assertError(result,RdfMappingPackage.Literals.LOGICAL_SOURCE, null, 154, 9, "No source declared for the logical-source")
		}
		...
		def void SourceShadowed() {
			...
			validationTester.assertIssue(result,RdfMappingPackage.Literals.LOGICAL_SOURCE, null, 299, 36, Severity.WARNING,"Source declared on source-group level is shadowed by source declared on logical-source.")
		}
}